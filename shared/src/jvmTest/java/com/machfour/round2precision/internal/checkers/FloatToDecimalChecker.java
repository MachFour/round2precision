...
import com.machfour.round2precision.internal.FloatToDecimal;
import org.jetbrains.annotations.NotNull;

import java.math.BigDecimal;
import java.util.Random;

import static com.machfour.round2precision.internal.MathUtilsKt.flog10pow2;
...
public class FloatToDecimalChecker extends ToDecimalChecker {
    ...
    private FloatToDecimalChecker(float v) {
        super(FloatToDecimal.Companion.toString(v));
    ...
    @Override
    public boolean recovers(BigDecimal bd) {
        return bd.floatValue() == v;
    }

    @Override
    public boolean recovers(String s) {
