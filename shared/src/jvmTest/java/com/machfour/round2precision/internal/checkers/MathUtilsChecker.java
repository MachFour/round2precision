package com.machfour.round2precision.internal.checkers;
...
import static com.machfour.round2precision.internal.MathUtilsKt.*;
...
public class MathUtilsChecker extends BasicChecker {
    ...
    private static final int H = flog10pow2(P) + 3; // was 2
    ...
    private static void testG() {
        for (int k = MATH_UTILS_K_MIN; k <= MATH_UTILS_K_MAX; ++k) {
            testG(k);
        }
    }
    ...
    */
    ...
    private static void testDecimalConstants() {
        addOnFail(K_MIN == MATH_UTILS_K_MIN, "K_MIN");
        addOnFail(K_MAX == MATH_UTILS_K_MAX, "K_MAX");
        addOnFail(H == MATH_UTILS_H, "H");
    }
